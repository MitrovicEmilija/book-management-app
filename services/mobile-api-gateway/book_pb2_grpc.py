...
class BookServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetBook = channel.unary_unary(
                ...
                _registered_method=True)
        self.GetBooksByUser = channel.unary_unary(
                '/book.BookService/GetBooksByUser',
                request_serializer=book__pb2.BookUserId.SerializeToString,
                response_deserializer=book__pb2.BookList.FromString,
                _registered_method=True)
        ...
        self.UpdateBook = channel.unary_unary(
                ...
                response_deserializer=book__pb2.Status.FromString,
                _registered_method=True)
...
class BookServiceServicer(object):
    ...
    def GetBooksByUser(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_BookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetBooksByUser': grpc.unary_unary_rpc_method_handler(
                    servicer.GetBooksByUser,
                    request_deserializer=book__pb2.BookUserId.FromString,
                    response_serializer=book__pb2.BookList.SerializeToString,
            ),
            ...
            'UpdateBook': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=book__pb2.Status.SerializeToString,
            ),
...
class BookService(object):
    ...
    def GetBooksByUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/book.BookService/GetBooksByUser',
            book__pb2.BookUserId.SerializeToString,
            book__pb2.BookList.FromString,
            options,
            channel_credentials,
            insecure,
